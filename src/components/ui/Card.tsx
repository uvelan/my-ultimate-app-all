...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-radius-xl border border-border bg-secondary text-text-primary transition-all duration-base ease-stitch hover:border-accent/40 hover:shadow-shadow-lg hover:-translate-y-[2px]",
      className
    )}
    {...props}
  />
