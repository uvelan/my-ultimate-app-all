...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-radius-xl border border-border bg-background-surface text-text-primary transition-all duration-300 ease-out hover:border-accent/30 hover:shadow-shadow-lg hover:-translate-y-[2px]",
      className
    )}
    {...props}
  />
