...
export const Modal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-space-4 bg-background/80 backdrop-blur-sm transition-premium animate-in fade-in">
      <div
        className={cn(
          "relative w-full max-w-lg rounded-radius-lg border border-border bg-background-surface shadow-xl animate-in zoom-in-95",
          className
        )}
      >
        <div className="flex flex-col space-y-space-2 p-space-6 pb-space-4">
        ...
        <div className="p-space-6 pt-0">{children}</div>
      </div>
      <div
